...
while True:
    ...
    cv2.imshow("Original", im)                           # display the frame.

    # get the image size and crop the frame to the area of interest (the dice).
    height, width, channels = im.shape
    # print(height, width, channels)
    # crop the frame to the area of interest (the dice).
    im = im[150:height-150,  100:width//2]                               # [y1:y2, x1:x2]

    # upsize the frame to make the dice pips easier to detect.
